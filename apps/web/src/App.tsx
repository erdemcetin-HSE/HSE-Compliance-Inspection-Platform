...
const textByLanguage: Partial<Record<Language, Record<string, string>>> = {
  tr: {
    ...
    'Training Completion': 'Eğitim Tamamlama',
    'PPE Stock Health': 'KKD Stok Sağlığı',
    'Dashboard': 'Gösterge Paneli',
    ...
    LTI: 'LTI',
    MTI: 'MTI',
    'First Aid Cases': 'İlk Yardım Vakaları',
    ...
    'Inspection Overdue': 'Denetimi Gecikmiş',
    ...
    'High Risks': 'Yüksek Riskler',
    'Medium Risks': 'Orta Riskler',
    'Low Risks': 'Düşük Riskler',
    ...
    'Environmental Incidents': 'Çevresel Olaylar',
    'Water Consumption': 'Su Tüketimi',
    'Electricity Consumption': 'Elektrik Tüketimi',
