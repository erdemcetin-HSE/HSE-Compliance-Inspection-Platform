...
export const dictionaries: Record<LanguageCode, Dictionary> = {
  ...
  ru: {
    ...
    subtitle:
      'Еженедельный/ежемесячный контроль KPI, отслеживание закрытия PTW/Observation, видимость рисков и контроль PPE в одном интерфейсе.',
    ...
    owner: 'Ответственный',
    status: 'Статус',
    observationStatus: 'Статус Observation',
    type: 'Тип',
    location: 'Локация',
